  ...
  return (
    <FormPageLayout>
      ...
      <FormSection>
        ...
        <FormInput placeholder="예: 3년차" />
      </FormSection>

      <FormSection>
        <FormLabel index={2} text="두 분의 닉네임을 알려주세요" />
        <div className="text-gray-8 mb-2 text-xs font-medium">
          <span className="text-primaryColor text-[20px]">•</span>
          여자
        </div>
        <FormInput placeholder="닉네임 입력" />
      ...
      <FormSection>
        ...
        <FormArea rows={4} placeholder="자유롭게 작성해주세요" />
      </FormSection>
      ...
      <PrimaryButton title="신청서 제출하기" className="w-full" />
    </FormPageLayout>
  );
};
